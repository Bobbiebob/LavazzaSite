...
<!--        <img src="\assets\images\Lavazza.png" alt="Logo" style="height:100%;">-->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav" >
            ...
            <li class="nav-item">
                <a class="nav-link <?=(\Application\Routing\Router::getURI() == 'exporter/select' ? 'active' : '');?>" href="/exporter/select">Export data</a>
            </li>
